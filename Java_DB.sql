...
CREATE TABLE `tb_pokemon_eletrico` (
  `id_eletrico` int NOT NULL,
  `pokemon` varchar(70) NOT NULL,
  `id` int DEFAULT NULL,
  `tipo` varchar(70) NOT NULL,
  PRIMARY KEY (`id_eletrico`),
  UNIQUE KEY `id` (`id`),
  CONSTRAINT `tb_pokemon_eletrico_ibfk_1` FOREIGN KEY (`id`) REFERENCES `tb_pokemon` (`id`),
  CONSTRAINT `tb_pokemon_eletrico_chk_1` CHECK ((`tipo` = _utf8mb4'Elétrico'))
...
CREATE TABLE `tb_pokemon_fogo` (
  ...
  CONSTRAINT `tb_pokemon_fogo_chk_1` CHECK ((`tipo` = _utf8mb4'Fogo'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_pokemon_voador` (
  ...
  CONSTRAINT `tb_pokemon_voador_chk_1` CHECK ((`tipo` = _utf8mb4'Voador'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-06-06 16:57:33
